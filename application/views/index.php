      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbar-collapse-1">
          <ul class="nav navbar-nav navbar-right">
            ...
            <li>
              <a class="btn btn-default btn-outline btn-circle collapsed"  data-toggle="collapse" href="#nav-collapse1" aria-expanded="false" aria-controls="nav-collapse1">Log In</a>
            </li>
          </ul>
          <ul class="collapse nav navbar-nav nav-collapse" id="nav-collapse1">
       
  <li> <button class="btn button -green center hbutton" type="submit">Login</button> </li>
       <li> <input type="password" class="form-control" name="password" placeholder="Password" required=""/></li>  
       <li> <input type="text" class="form-control" name="username" placeholder="Email Address" required="" autofocus="" /></li>
                ...
                <ul>
                    <li id="slide-one">
                       <div class="live-rate-head"> <h2>Live Rates</h2></div>
                        ...
                        <div class="col-sm-2 col-md-2">SUD: </div>
                        <div class="col-sm-2 col-md-2">ARE: </div>
                        <div class="col-sm-2 col-md-2">PAC: </div>
...
<!-- --------------------------------------------------- -->
      ...
      <label for="tab1"><i class="fa fa-code"></i><span>Buy/Sell</span></label>
      ...
      <label for="tab5"><i class="fa fa-envelope-o"></i><span>How It Works?</span></label>
